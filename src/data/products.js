export const products = [
    {
        ...
        specifications: [
            { label: { ar: "نظام التحميل", en: "Loading System" }, value: { ar: "آمن (Safe Load)", en: "Safe Load" } },
            { label: { ar: "الشكل", en: "Shape" }, value: { ar: "T", en: "T-Shape" } }
        ],
        features: {
            ar: ["يضمن التعقيم", "تقنية بدون لمس", "تحميل دقيق"],
            en: ["Ensures sterilization", "No-touch technique", "Accurate loading"]
        },
        brochureUrl: "#"
    },
    {
        ...
        specifications: [
            { label: { ar: "المادة", en: "Material" }, value: { ar: "نحاس بقلب فضي", en: "Copper with Silver Core" } }
        ],
        features: {
            ar: ["قلب فضي", "مرونة عالية", "عمر استخدام طويل"],
            en: ["Silver core", "High flexibility", "Long-term use"]
        },
        brochureUrl: "#"
    },
    {
        ...
        specifications: [
            { label: { ar: "تقنية الإدخال", en: "Insertion Technique" }, value: { ar: "دفع بيد واحدة", en: "One-hand push" } }
        ],
        features: {
            ar: ["ثبات أقوى", "سهولة الإدخال", "مناسب لجميع الأحجام"],
            en: ["Stronger stability", "Easy insertion", "Fits all sizes"]
        },
        brochureUrl: "#"
    },
    {
        ...
        specifications: [
            { label: { ar: "مدة الفعالية", en: "Effective Duration" }, value: { ar: "5 سنوات", en: "5 Years" } }
        ],
        features: {
            ar: ["نقاء عالٍ", "توافق حيوي", "وضع مثالي"],
            en: ["High purity", "Bio-compatible", "Optimal placement"]
        },
        brochureUrl: "#"
    },
    {
        id: "esa-uterine-sound",
        name: {
            ar: "مسبار esa (ESA Disposable Uterine Sound)",
        ...
        specifications: [
            { label: { ar: "التعقيم", en: "Sterilization" }, value: { ar: "أشعة جاما", en: "Gamma Rays" } }
        ],
        features: {
            ar: ["استخدام مرة واحدة", "دقة القياس", "معقم"],
            en: ["Single use", "Accurate measurement", "Sterile"]
        },
        brochureUrl: "#"
    },
    {
        ...
        specifications: [
            { label: { ar: "التقنية", en: "Technology" }, value: { ar: "شفط يدوي (MVA)", en: "Manual Vacuum Aspiration (MVA)" } }
        ],
        features: {
            ar: ["معتمد من WHO", "آمن وفعال", "سهل الاستخدام"],
            en: ["WHO Approved", "Safe & Effective", "User-friendly"]
        },
        brochureUrl: "#"
    },
    {
        ...
        specifications: [
            { label: { ar: "المادة الفعالة", en: "Active Ingredient" }, value: { ar: "تحت غالات البزموت", en: "Bismuth Subgallate" } }
        ],
        features: {
            ar: ["تركيبة أصلية", "علاج متعدد الاضطرابات", "متوافق مع الأدوية الأخرى"],
            en: ["Original formula", "Multi-disorder treatment", "Co-treatment compatible"]
        },
        brochureUrl: "#"
    },
    {
        id: "ovulation-test",
        name: {
            ar: "إختبار إباضة منزلي (LH Ovulation Test)",
        ...
        specifications: [
            { label: { ar: "العدد", en: "Count" }, value: { ar: "7 اختبارات", en: "7 Tests" } }
        ],
        features: {
            ar: ["دقة عالية", "أسهل من طرق التتبع التقليدية", "كشف مبكر"],
            en: ["High accuracy", "Easier than traditional methods", "Early detection"]
        },
        brochureUrl: "#"
    },
    {
        id: "pregnancy-midstream",
        name: {
            ar: "إختبار حمل منزلي (Midstream 6.0 mm)",
        ...
        specifications: [
            { label: { ar: "الحجم", en: "Size" }, value: { ar: "6.0 مم", en: "6.0 mm" } }
        ],
        features: {
            ar: ["كشف قبل الدورة بـ 7 أيام", "دقة 99%", "سهل الاستخدام"],
            en: ["Detect 7 days before period", "99% Accuracy", "Easy use"]
        },
        brochureUrl: "#"
    },
    {
        id: "pregnancy-cassette",
        name: {
            ar: "إختبار حمل منزلي (Cassette 4.0mm)",
        ...
        specifications: [
            { label: { ar: "النوع", en: "Type" }, value: { ar: "كاسيت 4.0 مم", en: "Cassette 4.0 mm" } }
        ],
        features: {
            ar: ["نتيجة مرئية واضحة", "كشف مبكر", "فعال وموثوق"],
            en: ["Clear visual result", "Early detection", "Effective & Reliable"]
        },
        brochureUrl: "#"
    }
];
